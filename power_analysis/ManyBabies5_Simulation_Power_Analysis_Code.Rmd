...
setwd("/Users/au620441/Desktop/sims_grid_search")
...
ggsave(plot = MainEffectGridSearchPlot, file = "Desktop/MainEffectGridSearchPlot.png", 
       height = 10, 
       width = 15)
ggsave(plot = InteractionEffectGridSearchPlot, file = "Desktop/InteractionEffectGridSearchPlot.png", 
       height = 10, 
       width = 15)


ggplot(error_bars) +
  geom_tile(col = "white", lwd = 1.5, linetype = 1, aes(y = power, x = n_subj)) +
  geom_tile(col = "white", lwd = 1.5, linetype = 1) +
