...
generate_dataset <- function(n_labs=30, n_per_lab=32, 
                             effect_sizes=list(type = .3, familiarization = .1, 
                                               age = .1, "age*type"=.1,
...
fit_simple_model <- function(siml) {
  m1 <- lmer(dv_zscore ~ 1 + stimulus_type * fam_time * age_mos + (1 | subjID) + (1 | labID), 
             data=siml)
  return(summary(m1)$coefficients[c(main_efs,"stimulus_type1:fam_time:age_mos"),"Pr(>|t|)"]) 
} 
...
fit_model <- function(siml) {
  ...
  sig = summary(m1)$coefficients[c(main_efs,"stimulus_type1:fam_time:age_mos"),"Pr(>|t|)"]
  return(sig)
}
...
### Effect sizes = .1
`r paste(length(which(pvalues_pt1$stimulus_type1<.05)), "of",N, "simulations had p <",.05, "for stimulus type.")`
`r paste(length(which(pvalues_pt1$age_mos<.05)), "of",N, "simulations had p <",.05, "for age.")`
`r paste(length(which(pvalues_pt1$fam_time<.05)), "of",N, "simulations had p <",.05, "for familiarization time.")`
`r paste(length(which(pvalues_pt1[,"stimulus_type1:fam_time:age_mos"]<.05)), "of",N, "simulations had p <",.05, "for age * stimulus type * familiarization time.")`
<!-- 147 of 1000 simulations had p < 0.05 for stimulus type.  775 of 1000 simulations had p < 0.05 for age. 1000 of 1000 simulations had p < 0.05 for familiarization time. 52 of 1000 simulations had p < 0.05 for age * stimulus type * familiarization time. -->


### Effect sizes = .2
`r paste(length(which(pvalues_pt2$stimulus_type1<.05)), "of",N, "simulations had p <",.05, "for stimulus type.")`
`r paste(length(which(pvalues_pt2$age_mos<.05)), "of",N, "simulations had p <",.05, "for age.")`
`r paste(length(which(pvalues_pt2$fam_time<.05)), "of",N, "simulations had p <",.05, "for familiarization time.")`
`r paste(length(which(pvalues_pt2[,"stimulus_type1:fam_time:age_mos"]<.05)), "of",N, "simulations had p <",.05, "for age * stimulus type * familiarization time.")`
<!-- 431 of 1000 simulations had p < 0.05 for stimulus type. 1000 of 1000 simulations had p < 0.05 for age. 1000of 1000 simulations had p < 0.05 for familiarization time. 68 of 1000 simulations had p < 0.05 for age *stimulus type * familiarization time. -->


### Effect sizes = .3
`r paste(length(which(pvalues_pt3$stimulus_type1<.05)), "of",N, "simulations had p <",.05, "for stimulus type.")`
`r paste(length(which(pvalues_pt3$age_mos<.05)), "of",N, "simulations had p <",.05, "for age.")`
`r paste(length(which(pvalues_pt3$fam_time<.05)), "of",N, "simulations had p <",.05, "for familiarization time.")`
`r paste(length(which(pvalues_pt3[,"stimulus_type1:fam_time:age_mos"]<.05)), "of",N, "simulations had p <",.05, "for age * stimulus type * familiarization time.")`
