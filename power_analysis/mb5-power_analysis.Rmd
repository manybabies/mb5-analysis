...
* *familiarization_time*: indicates how long each stimulus is exposed during familiarization (5, 10, or 15 seconds; within-infant; scaled to [-1,1]) 
...
generate_dataset <- function(n_labs=40, n_per_lab=32, 
  ...
  for(i in 1:nrow(simd)) {
    ...
    # since DV has SD~.2, and must be in the range [0,1], let's make floor=-2.5 and ceiling=2.5
