...
generate_dataset <- function(n_labs=30, n_per_lab=32, 
  ...
  familiarization_times = c(5,10,15) # or maybe we expect linear effect on log(fam_time)?
  fam_times_sc = c(-1,0,1) # scaled
...
<!-- 998 of 1000 simulations had p < 0.05 for stimulus type. 1000 of 1000 simulations had p < 0.05 for age. 1000of 1000 simulations had p < 0.05 for familiarization time. 45 of 1000 simulations had p < 0.05 for age *stimulus type * familiarization time. -->
