...
```{r, fig.width=6, fig.height=4.5, caption="z-scored proportion of novel looking by stimulus type by age, faceted by familiarization time. All simulated main and interaction effects are of size d=.3. Shaded regions denote bootstrapped 95% confidence intervals."}
...
fit_simple_model <- function(siml) {
  ...
  return(summary(m1)$coefficients[c(main_efs,"stimulus_type1:fam_time:age_mos"),"Pr(>|t|)"]) # "Estimate","t value",
} 
